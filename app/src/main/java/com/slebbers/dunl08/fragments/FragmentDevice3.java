...
public class FragmentDevice3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final CheckBox checkBox4 = (CheckBox) device3.findViewById(R.id.checkBox4);
        final CheckBox checkBox5 = (CheckBox) device3.findViewById(R.id.checkBox5);

        final List<CheckBox> checkboxes = new ArrayList<>();
        Context context = getActivity();
        final SharedPreferences sharedPreferences = context.getSharedPreferences(getString(R.string.preference_file_key3), Context.MODE_PRIVATE);
        ...
        tvEquipmentName.setText("device3");
        ...
        if(!savedPrefs.isEmpty()) {
            ...
            submit.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(device3.getContext(), "Saved equipment 1", Toast.LENGTH_LONG).show();
